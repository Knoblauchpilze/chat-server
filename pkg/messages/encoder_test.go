...
func TestUnit_Encode_RoomMessage(t *testing.T) {
	emitter := uuid.MustParse("9cd13f28-c560-4add-83de-eb6c473dea05")
	room := uuid.MustParse("b29504fe-279e-4312-8a7e-3fc95ce0afa5")
	content := "18 another message?"
	msg := NewRoomMessage(emitter, room, content)
